...
{
    public class RequiredIfMultiAttribute : ValidationAttribute, IClientValidatable
    {
        ...
        public RequiredIfMultiAttribute(string dependentProperty, params object[] targetValue)
        {
        ...
        public IEnumerable<ModelClientValidationRule> GetClientValidationRules(ModelMetadata metadata, ControllerContext context)
        {
            var rule = new ModelClientValidationRule()
            {
                ...
                ValidationType = "requiredifmulti",
            };
