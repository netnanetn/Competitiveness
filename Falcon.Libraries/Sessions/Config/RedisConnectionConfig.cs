namespace Falcon.Libraries.Sessions.Config
{
    ...
    public static class RedisConnectionConfig
    {
        ...
        #region Deprecated
        [Obsolete("Due to a change in Redis clients starting in v1.2.0, Falcon.Libraries.Sessions now only" +
        ...
        [Obsolete("Due to a change in Redis clients, v1.2.1 of Falcon.Libraries.Sessions now prefers to use the" +
