namespace Falcon.Libraries.Sessions
{
    ...
    using Falcon.Libraries.Sessions.Redis;
    using Falcon.Libraries.Sessions.Serialization;
    using StackExchange.Redis;
    
    /// <summary>
    /// This class is the main entry point into Falcon.Libraries.Sessions for your application. To enable
    ...
    public class RedisSessionStateStoreProvider : SessionStateStoreProviderBase
    {
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            {
                name = "Falcon.Libraries.Sessions";
            }
        ...
        /// <summary>
        /// This method does nothing in Falcon.Libraries.Sessions, since there is no way to create an empty
        ///     hash in Redis.
        /// </summary>
        ...
        /// <summary>
        /// Cleans up the Falcon.Libraries.Sessions, however it DOES NOT clear Redis data since each
        ...
        ///     because OnEnd is not supported in Falcon.Libraries.Sessions v1. A future implementation may use
        ...
        ///     the implementation of Falcon.Libraries.Sessions.RedisSessionStateItemCollection, this method
...
#pragma warning restore 0618
            ...
            throw new ConfigurationErrorsException(
                "Falcon.Libraries.Sessions.Config.RedisConnectionWrapper.GetSERedisServerConfig delegate not set " +
                "see project page at: github.com/welegan/Falcon.Libraries.Sessions#configuring-your-specifics");
        }
