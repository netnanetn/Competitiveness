namespace Falcon.Libraries.Sessions.Serialization
{
    using System;
    ...
    /// <summary>
    /// An interface containing the methods used by the Falcon.Libraries.Sessions to convert objects to strings
    ///     or byte arrays, to be written to Redis. Currently, Falcon.Libraries.Sessions only calls DeserializeOne
    ///     and SerializeWithDirtyChecking methods, though implementing the other methods will be helpful
    ///     during debugging. To set your own custom Serializer for Falcon.Libraries.Sessions, set the 
    ///     Falcon.Libraries.Sessions.Config.RedisSerializationConfig.SessionDataSerializer property to an 
    ///     instance of your Serializer class.
    /// </summary>
    public interface IRedisSerializer
    {
        /// <summary>
        /// Not used within Falcon.Libraries.Sessions in favor of lazy deserialization on a per-key basis, but
