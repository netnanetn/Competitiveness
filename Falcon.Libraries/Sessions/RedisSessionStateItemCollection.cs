namespace Falcon.Libraries.Sessions
{
    ...
    public class RedisSessionStateItemCollection : ISessionStateItemCollection, ICollection, IEnumerable
    {
        ...
        [Obsolete("This constructor is no longer used within Falcon.Libraries.Sessions, since moving to StackExchange.Redis"
        ...
        ///     Falcon.Libraries.Sessions.RedisSessionStateStoreProvider.SetAndReleaseItemExclusive method, which
        ///     only runs when this is true. This behavior may change in later versions of 
        ///     Falcon.Libraries.Sessions
        /// </summary>
        public bool Dirty
        {
            get
        ...
        public void RemoveAt(int index)
        {
            throw new NotImplementedException(
                "Falcon.Libraries.Sessions does not support Session access by integer index, please use only string indices");
        }
