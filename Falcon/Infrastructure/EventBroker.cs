    ...
    public class EventBroker
    {
        ...
        protected void Application_BeginRequest(object sender, EventArgs e)
        {
            if (BeginRequest != null && !IsStaticResource(sender))
            {
                ...
                if (EngineContext.Current.CheckLicense())
                {
                ...
                else
                {
                    ...
                    application.Response.Write("<h1>Licence is INVALID for this website. Please contact DKT Technology at <a href='http://dkt.com.vn'>http://dkt.com.vn</a></h1>");
