...
{
    /// <summary>
    /// A class that finds types needed by Falcon by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        private string assemblySkipLoadingPattern = "^System|^mscorlib|^Microsoft|^CppCodeProvider|^VJSharpCodeProvider|^WebDev|^Castle|^Iesi|^log4net|^NHibernate|^nunit|^MvcMiniProfiler|^RouteDebug|^Rhino|^QuickGraph|^Yahoo|^Telerik|^EcmaScript|^MvcContrib|^AjaxControlToolkit|^Antlr3|^AutoMapper|^Recaptcha|^AntiXSSLibrary|^Autofac|^Common|^NLog";
        private string assemblyRestrictToLoadingPattern = "^Falcon.*";
        ...
        public IEnumerable<Type> FindClassesOfType(Type assignTypeFrom, IEnumerable<Assembly> assemblies, bool onlyConcreteClasses = true)
        {
            ...
            foreach(var a in assemblies)
            {
                ...
                //catch (Exception e)
                //{
                //    Exception ex = new Exception("Error loading types from " + a.FullName + " :" + e.ToString());
                //    logger.Error(ex);
