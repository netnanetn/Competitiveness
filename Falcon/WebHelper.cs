...
namespace Falcon
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual bool IsLocalIpAddress()
        {
            string ip = GetCurrentIpAddress();
            string localIpPattern = "^127.|^192.|^10.";
            return Regex.IsMatch(ip, localIpPattern);
        }
        ...
        public virtual void RestartAppDomain(string redirectUrl = "")
        {
            ...
            else
            {
                ...
                if (!success)
                {
                    throw new FalconException("Orchard needs to be restarted due to a configuration change, but was unable to do so.\r\n" +
