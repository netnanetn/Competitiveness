...
$(window).scroll(function () {
    ...
    if ($(window).scrollTop() >= $('#page-item3').offset().top - 300 && $(window).scrollTop() < $('#page-item4').offset().top - 300) {
    ...
    if ($(window).scrollTop() >= $('#page-item4').offset().top - 300) {
        if ($('#page-item4 .url-img').attr('src') != $('#box-img img').attr('src')) {
            $('.menu-img').removeClass('active-img');
            $('#menu-img4').addClass('active-img');

            $('#box-img img').hide();
            $('#box-img img').attr('src', $('#page-item4 .url-img').attr('src'));
            $('#box-img img').fadeIn(300);
        }
    }
})
