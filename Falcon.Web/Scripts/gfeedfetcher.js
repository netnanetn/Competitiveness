...
var gfeedfetcher_loading_image = "/Themes/Portal/Default/Images/indicator.gif" //Full URL to "loading" image. No need to config after this line!!
...
gfeedfetcher.prototype._fetch_data_as_array = function(result, ddlabel) {
    ...
    if (thisfeed == "") { //if error has occured fetching feed
        console.log("Some blog posts could not be loaded: " + result.error.message)
    }
