...
<script runat="server">
	...
	private bool CheckAuthentication()
	{
        ...
        var context = Falcon.Infrastructure.EngineContext.Current;
        var workContext = context.Resolve<Falcon.IWorkContext>();
        if (workContext.CurrentUserId > 0) { return true; }
		return false;
	}
